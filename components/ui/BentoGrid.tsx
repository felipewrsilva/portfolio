  ...
  return (
    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        >
          <div className="z-10 select-none font-sans text-sm font-extralight text-[#C1C2D3] md:max-w-32 md:text-xs lg:text-base">
            {description}
          </div>
          <div className="z-10 max-w-96 select-none font-sans text-lg font-bold lg:text-3xl">
            {title}
          </div>
