...
const description =
  'Senior .NET engineer in Madrid. More than ten years with C# / .NET, SQL Server, and Azure across healthcare data, security, and SaaS. Remote-ready for EU hours and US Eastern overlap.'
